/**
 * @ignore
 * @param color color is an object returned by window.Core.Annotations.Color method
...
const getBrightness = (color) => {
  ...
  if (darkness < threshold || color.toHexString() === null) {
    // Also return dark color if selected transparency cell.
    return 'dark';
  }
