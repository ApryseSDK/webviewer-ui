...
const addToolsToDocViewer = docViewer => {
  ...
  toolModeMap.AnnotationCreateTextStrikeout2 = new window.Tools.TextUnderlineCreateTool(docViewer, 'AnnotationCreateTextStrikeout2');
  toolModeMap.AnnotationCreateTextStrikeout3 = new window.Tools.TextUnderlineCreateTool(docViewer, 'AnnotationCreateTextStrikeout3');
  toolModeMap.AnnotationCreateTextStrikeout4 = new window.Tools.TextUnderlineCreateTool(docViewer, 'AnnotationCreateTextStrikeout4');
  toolModeMap.AnnotationCreateTextSquiggly2 = new window.Tools.TextUnderlineCreateTool(docViewer, 'AnnotationCreateTextSquiggly2');
  toolModeMap.AnnotationCreateTextSquiggly3 = new window.Tools.TextUnderlineCreateTool(docViewer, 'AnnotationCreateTextSquiggly3');
  toolModeMap.AnnotationCreateTextSquiggly4 = new window.Tools.TextUnderlineCreateTool(docViewer, 'AnnotationCreateTextSquiggly4');
