...
const addToolsToDocViewer = docViewer => {
  ...
  toolModeMap.TextFormFieldCreateTool2 = new window.Tools.TextFormFieldCreateTool(docViewer, ToolNames.TEXT_FORM_FIELD2);
  toolModeMap.TextFormFieldCreateTool3 = new window.Tools.TextFormFieldCreateTool(docViewer, ToolNames.TEXT_FORM_FIELD3);
  toolModeMap.TextFormFieldCreateTool4 = new window.Tools.TextFormFieldCreateTool(docViewer, ToolNames.TEXT_FORM_FIELD4);
  toolModeMap.SignatureFormFieldCreateTool2 = new window.Tools.SignatureFormFieldCreateTool(docViewer, ToolNames.SIG_FORM_FIELD2);
  toolModeMap.SignatureFormFieldCreateTool3 = new window.Tools.SignatureFormFieldCreateTool(docViewer, ToolNames.SIG_FORM_FIELD3);
  toolModeMap.SignatureFormFieldCreateTool4 = new window.Tools.SignatureFormFieldCreateTool(docViewer, ToolNames.SIG_FORM_FIELD4);
  toolModeMap.ListBoxFormFieldCreateTool2 = new window.Tools.ListBoxFormFieldCreateTool(docViewer, ToolNames.LIST_BOX_FIELD2);
  toolModeMap.ListBoxFormFieldCreateTool3 = new window.Tools.ListBoxFormFieldCreateTool(docViewer, ToolNames.LIST_BOX_FIELD3);
  toolModeMap.ListBoxFormFieldCreateTool4 = new window.Tools.ListBoxFormFieldCreateTool(docViewer, ToolNames.LIST_BOX_FIELD4);
  toolModeMap.ComboBoxFormFieldCreateTool2 = new window.Tools.ComboBoxFormFieldCreateTool(docViewer, ToolNames.COMBO_BOX_FIELD2);
  toolModeMap.ComboBoxFormFieldCreateTool3 = new window.Tools.ComboBoxFormFieldCreateTool(docViewer, ToolNames.COMBO_BOX_FIELD3);
  toolModeMap.ComboBoxFormFieldCreateTool4 = new window.Tools.ComboBoxFormFieldCreateTool(docViewer, ToolNames.COMBO_BOX_FIELD4);
