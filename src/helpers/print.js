...
const getPrintableAnnotationNotes = (pageNumber) => core
  .getAnnotationsList()
  .filter(
...
const creatingImage = (pageNumber, includeAnnotations, maintainPageOrientation, isPrintCurrentView) => new Promise((resolve) => {
...
const creatingNotesPage = (annotations, pageNumber, dateFormat, language) => new Promise((resolve) => {
