...
export default function setSearchExecutor(store) {
  return function setSearchExecutorRedux(searchExecutorFn) {
    store.dispatch(actions.setSearchExecutor(searchExecutorFn));
  };
}
