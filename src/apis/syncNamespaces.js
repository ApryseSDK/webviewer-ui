...
/**
 * Syncs the namespaces under the Core namespace for this instance as well as others instances.
 * <br/><br/>
 * This is required when working with multiple instances of WebViewer since each loaded instance ends up with different classes despite sharing the same name.
 * @method Core.syncNamespaces
...
WebViewer(...)
  .then(function(instance) {
    ...
    // instance.Core.syncNamespaces({ PDFNet }, instance2, instance3);  // Alternative; instance, instance2, and instance3 will share the same PDFNet namespace.
    ...
  });
 */
