...
export const menuItems = {
  ...
  [PRESET_BUTTON_TYPES.NEW_SHEET_DOCUMENT]: {
    dataElement: PRESET_BUTTON_TYPES.NEW_SHEET_DOCUMENT,
    presetDataElement: DataElements.NEW_SHEET_DOCUMENT_PRESET_BUTTON,
    icon: 'icon-plus-sign',
