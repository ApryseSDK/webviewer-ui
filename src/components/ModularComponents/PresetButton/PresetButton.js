...
import EditorModeButton from './buttons/EditorMode';
...
const PresetButton = forwardRef((props, ref) => {
  const { buttonType, dataElement, groupedItem, isInEditorPanel } = props;
  ...
  const getPresetButton = () => {
    switch (buttonType) {
      ...
      case PRESET_BUTTON_TYPES.EDITOR_MODE:
        return <EditorModeButton {...props} ref={ref} />;
      default:
