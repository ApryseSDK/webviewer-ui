...
describe('NotesPanel', () => {
  ...
  describe('UI Tests', () => {
    ...
    it('NotesPanel should render default header and custom empty content', () => {
      const message = 'Custom empty panel message.';
    ...
    it('NotesPanel should render default header and custom render callback', () => {
      const message = 'Custom empty content goes here!';
      initialState.viewer.notesPanelCustomEmptyPanel = {
        render: () => {
    ...
    it('setCustomEmptyPanel should ignore other properties if render callback is provided', () => {
      const thisMessageShouldRender = 'Custom empty content goes here!';
      const thisMessageShouldNotRender = 'NOT RENDERING';

      initialState.viewer.notesPanelCustomEmptyPanel = {
        message: thisMessageShouldNotRender,
        render: () => {
          const div = document.createElement('div');
          const header = document.createElement('h2');
          header.innerHTML = thisMessageShouldRender;
          div.appendChild(header);
          return div;
        }
      };
