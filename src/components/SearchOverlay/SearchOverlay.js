...
function SearchOverlay(props) {
  ...
  const searchAndReplaceOne = React.useCallback(
    async function searchAndReplaceOneCallback() {
      ...
      // Do new search right after Infix server finishes updating content
      // of search and replace feature, executeSearch does not return correct
      // search results, executeSearch return old result. But if we timeout it
