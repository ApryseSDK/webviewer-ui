...
export default {
  viewer: {
    ...
    toolButtonObjects: {
      ...
      AnnotationCreateRedaction: { dataElement: 'redactionButton', title: 'action.redactCreate', img: 'ic_annotation_add_redact_black_24px', group: 'redactTools', showColor: 'never' },
