  ...
  viewer: {
    ...
    headers: {
      default: [
        ...
        { type: 'toolButton', toolName: 'Pan', dataElement: 'panToolButton' },
        { type: 'toolButton', toolName: 'TextSelect', dataElement: 'textSelectButton'},
        { type: 'toolButton', toolName: 'AnnotationEdit', dataElement: 'selectToolButton', hidden: [ 'tablet', 'mobile' ] },
