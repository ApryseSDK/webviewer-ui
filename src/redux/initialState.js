  ...
  viewer: {
    ...
    toolButtonObjects: {
      desktop: {
        ...
        AnnotationCreateCountMeasurement: { position: 5, dataElement: 'countMeasurementToolButton', title: 'annotation.countMeasurement', img: 'ic_check_black_24px', group: 'measurementTools', showColor: 'active' },
