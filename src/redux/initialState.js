...
export default {
  viewer: {
    ...
    toolButtonObjects: {
      ...
      [Tools.ToolNames.RECTANGULAR_AREA_MEASUREMENT]: { dataElement: 'rectangularAreaMeasurementToolButton', title: 'annotation.areaMeasurement', img: 'ic_annotation_square_black_24px', group: 'measurementTools', showColor: 'active' },
